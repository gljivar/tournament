...
respond_to :json
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.json { render json: @competitors.to_json(:include => { :category => { :only => [:name] }, :club => { :only => [:name] } } ) }
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.json { render json: @competitor.to_json(:include => { :category => { :only => [:name] }, :club => { :only => [:name] } } ) }
    end
  end
